...
const seoMeta = new Map([
  ...
  [
    ...
    {
      tr: {
        title: "Ses Editörü: Kes, Normalize Et ve Dönüştür",
        description: "MP3, WAV, FLAC ve diğer ses dosyalarını tek yüklemede kesin, normalize edin ve dönüştürün. Tarayıcıda çalışır, sunucuya yükleme yok.",
      },
      en: {
        title: "Audio Editor: Trim, Normalize and Convert Audio",
        description: "Trim, normalize and convert MP3, WAV, FLAC and other audio files with one upload. Runs in your browser with no server upload.",
      },
    },
  ],
  [
...
const enLocalizationReplacements = new Map([
  [
    ...
    [
      ...
      ['"1 dosya seçildi"', '"1 file selected"'],
      ['"Birleştir"', '"Merge"'],
      ['"Bu PDF içinde belirgin bir metin tablosu bulunamadı."', '"No distinct text table was found in this PDF."'],
      ['"Böl"', '"Split"'],
      ['"DOCX Oluştur"', '"Create DOCX"'],
      ['"Daha güçlü sıkıştırma"', '"Stronger compression"'],
      ['"Dosya seç veya sürükle"', '"Choose or drop a file"'],
      ['"Dönüştür"', '"Convert"'],
      ['"Dönüştürme başarısız."', '"Conversion failed."'],
      ['"Dönüştürme hazırlanıyor."', '"Preparing conversion."'],
      ['"Dönüştürme sunucusu hata verdi."', '"The conversion server returned an error."'],
      ['"Dönüştürülecek görsel bulunamadı."', '"No image was found to convert."'],
      ['"Dönüştürülüyor..."', '"Converting..."'],
      ['"Düzenle"', '"Edit"'],
      ['"Dışarı Aktar"', '"Export"'],
      ['"Ghostscript WASM başlatılamadı."', '"Ghostscript WASM could not be started."'],
      ['"Görsel PDF\'e hazırlanamadı."', '"The image could not be prepared for PDF."'],
      ['"Görsel canvas\'a çizilemedi."', '"The image could not be drawn to the canvas."'],
      ['"Görsel ve Office dosyalarını aynı seferde karıştırmayalım. Önce bir grup seç."', '"Choose either image files or Office files, not both at the same time."'],
      ['"Görsel veya Office dosyasını PDF\'e çevir."', '"Convert an image or Office file to PDF."'],
      ['"Helper kapalı"', '"Helper offline"'],
      ['"Henüz dosya seçilmedi."', '"No file selected yet."'],
      ['"Maks. sütun"', '"Max columns"'],
      ['"Metin tabanlı tabloları CSV veya Excel olarak çıkarır."', '"Extracts text-based tables as CSV or Excel."'],
      ['"OCR ile Oluştur"', '"Create with OCR"'],
      ['"Office dönüşümü için cihazındaki PDF helper çalışmalı."', '"The local PDF helper must be running for Office conversion."'],
      ['"Office hazır"', '"Office ready"'],
      ['"Onarım tamamlandı. Acrobat uyumlu PDF indirildi."', '"Repair completed. An Acrobat-compatible PDF was downloaded."'],
      ['"Opaklık"', '"Opacity"'],
      ['"PDF arşivi hazır"', '"PDF archive ready"'],
      ['"PDF hazır"', '"PDF ready"'],
      ['"PDF hazır. İndirme senin seçimine bırakıldı."', '"PDF ready. Download it when you choose."'],
      ['"PDF hazır. İndirmek için Dönüştür sekmesini kullan."', '"PDF ready. Use the Convert tab to download it."'],
      ['"PDF metin katmanını çıkarıp DOCX olarak kaydeder."', '"Extracts the PDF text layer and saves it as DOCX."'],
      ['"PDF seç veya sürükle"', '"Choose or drop a PDF"'],
      ['"PDF\'e Dönüştür"', '"Convert to PDF"'],
      ['"Repair başarısız."', '"Repair failed."'],
      ['"Sayfaları böl, birleştir, sil, döndür veya dışa aktar."', '"Split, merge, delete, rotate, or export pages."'],
      ['"Sağa döndür"', '"Rotate right"'],
      ['"Seçili dosya"', '"Selected file"'],
      ['"Sunucu hatası."', '"Server error."'],
      ['"Sıkıştır"', '"Compress"'],
      ['"Sıkıştırma başarısız."', '"Compression failed."'],
      ['"Sıkıştırma motoru kontrol ediliyor..."', '"Checking the compression engine..."'],
      ['"Sıkıştırma motoru çalışmıyor. `pdf-compress-server` açık ve Ghostscript hazır olmalı."', '"The compression engine is unavailable. `pdf-compress-server` must be running and Ghostscript must be ready."'],
      ['"Taranmış sayfaları OCR ile okuyup DOCX olarak kaydeder."', '"Reads scanned pages with OCR and saves them as DOCX."'],
      ['"Tarayıcıda"', '"In browser"'],
      ['"küçüldü"', '"reduced"'],
      ['"Çıkarma işlemi başarısız."', '"Extraction failed."'],
      ['"Önizleme hazırlanamadı. Filigran yine de uygulanabilir."', '"The preview could not be prepared. The watermark can still be applied."'],
      ['"İleri Al"', '"Redo"'],
    ],
  ],
  [
    ...
    [
      ...
      ['"50 MB üzeri CSV dosyalarında tarayıcı belleği zorlanabilir."', '"CSV files over 50 MB may strain browser memory."'],
      ['"Ana veriyi günceller. Geri alma yok."', '"Updates the source data. This cannot be undone."'],
      ['"Anahtarı seç, sonucu üret."', '"Choose a key and generate the result."'],
      ['"Birleştir"', '"Merge"'],
      ['"CSV dosyanı yükle ve düzenle."', '"Upload and edit your CSV file."'],
      ['"CSV dosyası okunamadı."', '"The CSV file could not be read."'],
      ['"CSV dosyasını seç veya sürükle"', '"Choose or drop a CSV file"'],
      ['"CSV İndir"', '"Download CSV"'],
      ['"CSV, TSV ve text dosyaları desteklenir."', '"CSV, TSV, and text files are supported."'],
      ['"Değiştirme uygulandı."', '"Replacement applied."'],
      ['"Görünür sütunlarla oluşan çıktı"', '"Output generated from visible columns"'],
      ['"Görünürlük, isim ve sıra."', '"Visibility, name, and order."'],
      ['"Hiçbirini Seç"', '"Select None"'],
      ['"JSON İndir"', '"Download JSON"'],
      ['"Kuralları birlikte uygula."', '"Apply rules together."'],
      ['"Noktalı Virgül (;)"', '"Semicolon (;)"'],
      ['"Sol birleştirme"', '"Left join"'],
      ['"Sütunları seç, filtrele, temizle ve indir."', '"Select, filter, clean, and download columns."'],
      ['"Türkçe Excel için Windows-1254 gerekebilir."', '"Windows-1254 may be required for Turkish Excel files."'],
      ['"Virgül (,)"', '"Comma (,)"'],
      ['"Yükleniyor..."', '"Loading..."'],
      ['"Çıktı Ayracı"', '"Output delimiter"'],
      ['"Önizleme"', '"Preview"'],
      ['"İkinci CSV\'yi seç"', '"Choose the second CSV"'],
      ['"İkinci dosyada eşleşme sütunu"', '"Match column in the second file"'],
      ['"İlk satır korunur. Geri alma yok."', '"The first row is kept. This cannot be undone."'],
      ['"İç birleştirme"', '"Inner join"'],
      [" kaydın ilk ", " records, showing the first "],
      [" satırı gösteriliyor", " rows"],
      [" kayıt gösteriliyor", " records shown"],
      [" tekrarlı satır silindi.", " duplicate rows removed."],
      [" satır, ", " rows, "],
      [" sütun`", " columns`"],
      ['" gösteriliyor"', '" shown"'],
      ['" sütun"', '" columns"'],
      [" sütun.`", " columns.`"],
      ["Tekrarlı satır bulunamadı.", "No duplicate rows found."],
      ['"İkinci dosyayı yükle."', '"Upload the second file."'],
      ["Birleştirme tamamlandı:", "Merge completed:"],
  ...
  [
    ...
    [
      ...
      ['"Kaydettiğin QR\'lar burada görünür."', '"Your saved QR codes will appear here."'],
      ['"Mail hazırla"', '"Compose email"'],
      ['"Renk, boyut ve çıktı ayarları"', '"Color, size, and output settings"'],
      ['"Önizleme"', '"Preview"'],
    ],
  ],
  [
    ...
    [
      ...
      ['"Görselleri eklemek için bırak"', '"Drop images to add them"'],
      ['"Mevcut liste ve ayarlar korunur."', '"The current list and settings will be preserved."'],
      ['"Görselleri seç veya sürükle."', '"Choose or drag images."'],
      ['children:"Görselleri seç"', 'children:"Choose images"'],
      ['children:"veya sürükle."', 'children:"or drag them."'],
      ['"Görselleri boyutlandır, sıkıştır, kırp ve indir."', '"Resize, compress, crop, and download images."'],
      ...
      ['"Akıllı Sıkıştır"', '"Smart Compress"'],
      ['"Düşük kalite"', '"Low quality"'],
      ['"Görsel indirildi."', '"Image downloaded."'],
      ['"Görsel işleme modu"', '"Image processing mode"'],
      ['"Görseller indirilemedi."', '"Images could not be downloaded."'],
      ['"Görseller işleniyor..."', '"Processing images..."'],
      ['"Kırp"', '"Crop"'],
      ['"Kırpıldı"', '"Cropped"'],
      ['"Seçili görseller indirilemedi."', '"Selected images could not be downloaded."'],
      ['"Smart compress işlemi başarısız."', '"Smart compression failed."'],
      ['"Sıkıştır"', '"Compress"'],
      ['"Yüksek kalite"', '"High quality"'],
      ['"ZIP oluşturulamadı."', '"The ZIP file could not be created."'],
      ['"İptal"', '"Cancel"'],
      ["görsel ZIP olarak indirildi.", "images downloaded as ZIP."],
      ["görsel eklendi.", "images added."],
      ["dosya atlandı.", "files skipped."],
      [" GIF dosyaları ilk kare olarak işlenir.", " GIF files are processed as the first frame."],
      [" kaldır`", " remove`"],
      ['" görsel"', '" images"'],
      [" görsel`", " images`"],
      ['"Görseller yüklenemedi."', '"Images could not be loaded."'],
    ],
  ],
  [
    "exif-cleaner",
    [
      ...
      ['"Fotoğrafları eklemek için bırak"', '"Drop photos to add them"'],
      ['"Mevcut liste ve ayarlar korunur."', '"The current list and settings will be preserved."'],
      ...
      ['"İndir"', '"Download"'],
      ['"EXIF ve GPS izlerini temiz kopyadan kaldır."', '"Remove EXIF and GPS traces from the clean copy."'],
      ['"Fotoğraflardaki metadata izlerini temizle."', '"Remove metadata traces from photos."'],
      ['"Fotoğrafları seç veya sürükle"', '"Choose or drop photos"'],
      ['"GPS ve cihaz bilgilerini temiz kopyadan kaldır."', '"Remove GPS and device information from the clean copy."'],
      ['"Temiz kopyaları indir."', '"Download clean copies."'],
      ['"Çıktı formatını seç ve dışa aktar."', '"Choose an output format and export."'],
      ["dönüştürülemedi.", "could not be converted."],
  ...
  [
    ...
    [
      ...
      ['"Dönüştürülüyor..."', '"Converting..."'],
      ['"İndir"', '"Download"'],
      ['"Dönüştür ve indir."', '"Convert and download."'],
      ['"Görselleri farklı formata dönüştür."', '"Convert images to another format."'],
      ['"Görselleri seç veya sürükle"', '"Choose or drop images"'],
      ['"Kırp"', '"Crop"'],
      ['"Kırpıldı ✓"', '"Cropped ✓"'],
      ['"Tek dosyayı indir, çoklu dosyayı ZIP olarak al."', '"Download one file directly or receive multiple files as a ZIP."'],
      ['"İptal"', '"Cancel"'],
      ["dönüştürülemedi.", "could not be converted."],
      ["yüklenemedi.", "could not be loaded."],
      ["olarak hazırlandı.", "prepared as."],
  ...
  [
    ...
    [
      ...
      ['"Görseller cihazında işlenir."', '"Images are processed on your device."'],
      ['"IMG.LY CDN üzerinden alınır."', '"Downloaded from the IMG.LY CDN."'],
      ['"Model ilk açılışta indirilir."', '"The model is downloaded on first launch."'],
      ['"Sonraki açılışlar daha hızlıdır."', '"Subsequent launches are faster."'],
      ['"Tıkla veya yeni dosya bırak."', '"Click or drop another file."'],
      ["görsel tamamlandı", "images completed"],
      ["görsel hazır", "images ready"],
      ["görsel", "image"],
      ["küçük", "smaller"],
    ],
  ],
  [
    ...
    [
      ...
      ['"Ses önizlemesi hazırlanıyor..."', '"Preparing audio preview..."'],
      ...
      ['children:"Ses dosyası üretildi"', 'children:"Audio file created"'],
      ...
      ['"Özet"', '"Summary"'],
      ['children:"Kes ve önizle"', 'children:"Trim and preview"'],
      ['children:"Başlangıç"', 'children:"Start"'],
      ['children:"Bitiş"', 'children:"End"'],
      ['children:"Oynatma imleci"', 'children:"Playhead"'],
      ['children:"Seçim süresi"', 'children:"Selection duration"'],
      ['children:"Seçim"', 'children:"Selection"'],
      ['children:"0,1 sn"', 'children:"0.1 sec"'],
      ['children:"sn"', 'children:"sec"'],
      ['"Duraklat"', '"Pause"'],
      ['"Oynat"', '"Play"'],
      ['aria-label:"Hassas zaman ayarı"', 'aria-label:"Fine time adjustment"'],
      ['aria-label:"Seçili noktayı 0,1 saniye geri al"', 'aria-label:"Move the selected point back by 0.1 seconds"'],
      ['aria-label:"Seçili noktayı 0,1 saniye ileri al"', 'aria-label:"Move the selected point forward by 0.1 seconds"'],
      ['title:"0,1 saniye geri"', 'title:"Back 0.1 seconds"'],
      ['title:"0,1 saniye ileri"', 'title:"Forward 0.1 seconds"'],
      ['"Ses önizleme dalga formu. Yön tuşlarıyla seçili noktayı hassas ayarla."', '"Audio preview waveform. Use the arrow keys to fine-tune the selected point."'],
      ['"Dalga formu bu video biçiminde gösterilemiyor; zaman seçimi kullanılabilir."', '"The waveform cannot be displayed for this video format; time selection is still available."'],
      ['children:"Dalga formu bu video biçiminde gösterilemiyor. Zaman seçimi ve ses önizlemesi kullanılabilir."', 'children:"The waveform cannot be displayed for this video format. Time selection and audio preview are still available."'],
      ['children:"Ses önizlemesi bu video biçiminde kullanılamıyor."', 'children:"Audio preview is not available for this video format."'],
      ['children:"Video yine tam uzunlukta ses dosyasına dönüştürülebilir."', 'children:"The full video can still be converted to an audio file."'],
      ['"Bu video biçiminde ses önizlemesi başlatılamadı."', '"Audio preview could not be started for this video format."'],
      ['"Ses önizlemesi bu video biçiminde kullanılamıyor. Video tam uzunlukta işlenebilir."', '"Audio preview is not available for this video format. The full video can still be processed."'],
      ['"Video önizlemesi hazırlanamadı."', '"Video preview could not be prepared."'],
      ['"Seçim en az 0,1 saniye olmalı."', '"Selection must be at least 0.1 seconds."'],
      ['"Tüm video"', '"Full video"'],
      ['"İpucu"', '"Tip"'],
      ...
      ['"Format ve kalite seç."', '"Choose format and quality."'],
      ['"3 format"', '"3 formats"'],
      ['"Hassas zaman ayarı"', '"Fine time adjustment"'],
      ['"Kayıpsız"', '"Lossless"'],
      ['"Kolay yükle"', '"Easy upload"'],
      ['"MP3, WAV veya orijinal ses akışı olarak indir."', '"Download as MP3, WAV, or the original audio stream."'],
      ['"Seç veya sürükle"', '"Choose or drop"'],
      ['"Seçili noktayı 0,1 saniye geri al"', '"Move the selected point back by 0.1 seconds"'],
      ['"Seçili noktayı 0,1 saniye ileri al"', '"Move the selected point forward by 0.1 seconds"'],
      ['"Tarayıcıda çalışır"', '"Runs in the browser"'],
      ['"Video seç veya sürükle"', '"Choose or drop a video"'],
      ['"Video süresi okunamadı."', '"The video duration could not be read."'],
      ['"Videodan ses çıkar."', '"Extract audio from video."'],
      [" · Seçim ", " · Selection "],
    ],
  ],
  [
    "audio-editor",
    [
      ['children:"Sesi kes, dengele"', 'children:"Trim, balance"'],
      ['children:"ve dönüştür."', 'children:"and convert."'],
      ['children:"Tek yüklemede kırp, normalize et ve istediğin formatta dışa aktar."', 'children:"Trim, normalize, and export in your preferred format with a single upload."'],
      ['"Ses dosyası seç veya sürükle"', '"Choose or drop an audio file"'],
      ['"Ses düzenleniyor..."', '"Editing audio..."'],
      ['"Ses işlenemedi."', '"Audio could not be processed."'],
      ['children:"Dışa Aktar"', 'children:"Export"'],
      ...
      ['title:"0,1 saniye ileri"', 'title:"Forward 0.1 seconds"'],
      ['children:"0,1 sn"', 'children:"0.1 sec"'],
      ['children:"Başlangıç, bitiş veya imleci seç. Yön tuşları 0,1 sn, Shift + yön tuşları 1 sn ilerletir."', 'children:"Select the start, end, or playhead. Arrow keys move 0.1 sec; Shift + arrow keys move 1 sec."'],
      ['children:"İstersen çıktıya normalizasyon uygula."', 'children:"Optionally normalize the output audio."'],
      ['children:"Normalizasyon"', 'children:"Normalization"'],
      ['"Açık"', '"On"'],
      ['"Kapalı"', '"Off"'],
      ['children:"Çıktıya ses seviyesi düzenlemesi uygulanmaz."', 'children:"No level normalization will be applied to the output."'],
      ['children:"Çıktı formatı"', 'children:"Output format"'],
      ['children:"Dosya türünü ve kaliteyi seç."', 'children:"Choose the file type and quality."'],
      ['children:"Küçük dosya"', 'children:"Smaller file"'],
      ...
      ['label:"Kes"', 'label:"Trim"'],
      ['label:"Dönüştür"', 'label:"Convert"'],
      ['desc:"Kırp"', 'desc:"Trim"'],
  ...
  [
    ...
    [
      ...
      ['"Ayrılmış vokal"', '"Separated vocals"'],
      ['"Cihazındaki stem engine aranıyor."', '"Looking for the stem engine on your device."'],
      ['"Dosya cihazında kalır."', '"The file stays on your device."'],
      ['"FFmpeg binary\'si bulunamadı."', '"The FFmpeg binary could not be found."'],
      ['"Henüz başlatılmadı."', '"Not started yet."'],
      ['"Local helper gerekir. Dosya cihazında işlenir."', '"A local helper is required. The file is processed on your device."'],
      ['"Local helper ile stem çıktıları üret."', '"Create stem outputs with the local helper."'],
      ['"Model warm-up tamamlanamadı."', '"Model warm-up could not be completed."'],
      ['"Model ısınıyor. Track seçebilirsin."', '"The model is warming up. You can choose a track."'],
      ['"Python runtime bulunamadı."', '"The Python runtime could not be found."'],
      ['"Stem separation başlat ve çıktıları indir."', '"Start stem separation and download the outputs."'],
      ['"Track hazır."', '"Track ready."'],
      ['"Vocal ve instrumental ayır."', '"Separate vocals and instrumental."'],
      ['"Vokalsiz çıktı"', '"Instrumental output"'],
    ],
  ],
  [
    "dev-toolkit",
    [
      ...
      ['"AES-GCM ile şifrele veya çöz."', '"Encrypt or decrypt with AES-GCM."'],
      ['"Digest üret."', '"Generate a digest."'],
      ['"Hash doğrula."', '"Verify a hash."'],
      ['"Hash üret ve doğrula."', '"Generate and verify hashes."'],
      ['"Header ve payload\'ı çöz. İmza doğrulamaz."', '"Decode the header and payload. Signature is not verified."'],
      ['"JS kodunu karmaşıklaştır."', '"Obfuscate JavaScript code."'],
      ['"JS gizle."', '"Obfuscate JS."'],
      ['"JSON örneğinden TS tipi üret."', '"Generate a TypeScript type from a JSON sample."'],
      ['"Metin, token ve sorgu araçları."', '"Text, token, and query tools."'],
      ['"Formatla."', '"Format."'],
      ['"Payload çöz."', '"Decode payload."'],
      ['"SHA digest üret."', '"Generate a SHA digest."'],
      ['"Tip çıkar."', '"Infer types."'],
      ['"Unicode destekli dönüştürme."', '"Unicode-safe conversion."'],
      ['"Şifrele / çöz."', '"Encrypt / decrypt."'],
      [" panoya kopyalandı.", " copied to the clipboard."],
    ],
  ],
]);
...
function buildEnglishAppCopies(siteRoot) {
  ...
  for (const [appId, replacements] of enLocalizationReplacements) {
    ...
    for (const filePath of collectFiles(appRoot)) {
      ...
      const original = readFileSync(filePath, "utf8");
      const updated = replaceAllTracked(original, replacements).replace(/[ \t]+$/gm, "");
      if (updated !== original) {
        writeFileSync(filePath, updated);
      }
    }
  ...
  // English apps must always start from the freshly built Turkish bundle.
  // Overlaying archived bundles here silently restores outdated app versions.
