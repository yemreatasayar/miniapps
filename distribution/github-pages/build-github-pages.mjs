...
const enLocalizationReplacements = new Map([
  [
    ...
    [
      ...
      ['"Split tamamlandı."', '"Split completed."'],
      ['"Split işlemi başarısız."', '"Split failed."'],
      ['"Merge işlemi başarısız."', '"Merge failed."'],
      ...
      ['"Text extraction başarısız."', '"Text extraction failed."'],
      ['"Tablo yapısı analiz ediliyor."', '"Analyzing table structure."'],
      ['"Tablo bulunamadı."', '"No table found."'],
      ['"Table extraction başarısız."', '"Table extraction failed."'],
